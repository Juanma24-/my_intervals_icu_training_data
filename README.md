...
![Sync Status](https://github.com/Juanma24-/my_intervals_icu_training_data/actions/workflows/auto-sync.yml/badge.svg)

**Last successful sync:** 2026-04-03 13:13:49 UTC
...
|------|-------------|------|
| `latest.json` | Current 7-day snapshot + derived metrics | [View](https://raw.githubusercontent.com/Juanma24-/my_intervals_icu_training_data/main/latest.json) |
| `history.json` | Longitudinal data (daily/weekly/monthly) | [View](https://raw.githubusercontent.com/Juanma24-/my_intervals_icu_training_data/main/history.json) |
...
- Current: https://raw.githubusercontent.com/Juanma24-/my_intervals_icu_training_data/main/latest.json
- History: https://raw.githubusercontent.com/Juanma24-/my_intervals_icu_training_data/main/history.json
```
